...
class QHexCodes:
    __hexMap = {
            ...
            0x110: [["Ax", "Ay", "Az"], 
                    {
                        "long_name": ["acceleration_X", "acceleration_Y", "acceleration_Z",],
                        },
                    ],
            0x120: [["Ax", "Ay"], 
                    {
                        "long_name": ["piezo_X", "piezo_Y",],
                        },
                    ],
            0x130: [["Incl_X", "Incl_Y", "Incl_T"],
                    {
                        "long_name": ["Inclinometer_X", "Inclinometer_Y", "Inclinometer_T"],
                        "units": ["degrees", "degrees", "Celsius"],
                        },
                    ],
            0x140: [["thetaX", "thetaY"],
                    {
                        "long_name": ["Theta_X", "Theta_Y"],
                        "units": "degrees",
                        },
                    ],
            0x150: [["Mx", "My", "Mz"],
                    {
                        "long_name": ["magnetic_X", "magnetic_Y", "magnetic_Z",],
                        },
                    ],
            0x160: ["pressure", 
                    {
